...
client.once('ready', () => {
  ...
  client.user.setActivity("spoons help | 2 servers");
});
...
client.on('message', message =>{
    ...
    if(command === 'ping'){
        ...
        message.channel.send('Check out a full list of commands here ...');
...
client.login('NzQ0MzE2NjY4MzE4MDU2NDY4.Xzhc6g.Ic9kBZue__uKzWO1LfSKEWvciLM');